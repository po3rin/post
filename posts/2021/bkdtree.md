...
date: 2021/02/04
id: bkdtree
description: Elasticsearchの数値データインデックスに使われるBkd-Treeというアルゴリズムを論文を読みながらまとめました。
tags:
    - Computer Science
    - Algorithm
---
...
普通のkd-treeはポイントを最初にソートしてルートからトップダウンで構築しますが、ここで1つのレベルを1個ずつ作成する代わりにある高さまで一気に木を構築する方法が紹介されています。。
